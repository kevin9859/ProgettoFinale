                ...
                @if (Auth::user())
                    ...
                    <div class="d-flex justify-content-between bg-white flex-lg-row flex-column" style="padding: 8vh;">
                        <div class="col-lg-7 col-md-12 mb-5 d-flex justify-content-end mt-5">
                            ...
                            <div class="min-vh100"style="max-width: 600px;">
                                ...
                                <p class="lead text-justify font-rounded " style="font-size:2vh;margin-bottom:2vh;">
                                    Benvenuto nella nostra <strong>comunità giornalistica</strong>, dove ogni parola ha
                                    valore e
                                    ogni storia trova spazio.</p>
                                <p class="lead text-justify font-rounded" style="font-size: 2vh;margin-bottom:2vh;">La
                                    tua
                    ...
                    <div class="d-flex justify-content-center bg-yellow2">
                        ...
                        <a href="{{ route('article.create') }}"><button
                                class="button-glitch align-items-center justify-content-center m-4">CREA UN
                                ARTICOLO</button>
                        </a>
                    </div>
                    <div class="row" style="flex-direction: column; align-items: start; justify-content: start;">
                        <div class="" style="flex-direction: column; align-items: start; justify-content: start;">
                            @foreach ($articles as $article)
                                <div class="col"
                                    style="flex-direction: column; align-items: start; justify-content: center;">
                        ...
                        <div class="col-lg-5 col-md-12 d-flex px-5">
                            <div class="welcome-text justify-content-start" style="padding-left: 20px;">
                                <span class="small-text"
                                    ...
                                    abbiamo</span>
                                <span class="large-text mx-3"
                                    style="font-family: 'Roboto', sans-serif; font-size: 1.3vw; letter-spacing: 1px;">bisogno
                                    di
                                    te</span>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between bg-white flex-lg-row flex-column-reverse"
                        style="padding: 8vh;">
                        <div class="col-lg-7 col-md-12 mb-5 mx-auto order-2 order-lg-1">
                            <div class="row">
                                ...
                                <div class="col-xl-7 col-lg-12 d-flex flex-column justify-content-center mx-md-3"
                                    style="max-width: 600px;">
                                    <p class="lead text-justify font-rounded mb-4"
                                        style="font-size:1em;margin-bottom:2vh;">Siamo sempre alla ricerca di menti
                                        curiose e appassionate come la tua per arricchire il nostro sito con punti di
                                        vista unici e freschi.</p>
                                    <p class="lead text-justify font-rounded mb-4 "
                                        style="font-size:1em;margin-bottom:2vh;">Se hai un'opinione da condividere,
                                        una passione da esprimere o semplicemente un interesse per la scrittura
                                        giornalistica, il nostro sito è il posto perfetto per te!</p>
                                    <p class="lead text-justify font-rounded mb-4"
                                        style="font-size:1em;margin-bottom:2vh;">Unisciti a noi e lascia il tuo segno
                                        nel mondo delle notizie online. Siamo sicuri che il tuo contributo porterà nuova
                                        vita e vivacità al nostro sito!</p>
                                </div>
                            </div>
                        </div>
                    </div>

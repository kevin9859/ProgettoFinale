<x-layout-create>
        ...
        <div class="row h-100 justify-content-center align-items-center">
            ...
            <div class="container-fluid p-0" style="background-color: white;">
                <div class="row  justify-content-end align-items-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8 m-3">
                        <h1 class="mt-4 titolo-glitch align-items-center justify-content-end p-1"style="font-size:100px;min-width:750px;margin-right:50px;">
                ...
                <div class="row h-100 justify-content-start align-items-center">
                    <div class="col-lg-4 col-md-6 col-sm-8 m-3 d-flex flex-row align-items-center">
                        <img src="/images/category-create.png" alt="Immagine di prova" class="img-fluid mb-3"
                            style="max-width:70%;margin-right:100px;"> <!-- Aggiungi qui la tua immagine di prova -->
            ...
            <div class="container-fluid h-100 p-0" style="">
                <div class="row h-100 justify-content-center align-items-center">
                    <div class="col-lg-4 col-md-6 col-sm-8 m-3">
                        ...
                        <div>
                            <button class="mt-4 category-button button-glitch2 align-items-center justify-content-center">Inserisci un articolo</button>
                            <button class="mt-4 category-button button-glitch2 align-items-center justify-content-center ml-4" href="{{ route('homepage') }}">Torna
                                alla
                                home</button>
                        </div>
                    </div>
    ...
    <style>
        ...
        /* .highlight {
            box-shadow: 0 0 10px 5px rgb(167, 168, 166);
        } */
    </style>
</x-layout-create>

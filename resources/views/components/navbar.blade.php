<nav class="navbar navbar-expand-lg navbar-transparent bg-transparent">
    <div class="container-fluid d-flex justify-content-between">
        ...
        <div class="d-flex justify-content-center custom-nav-link flex-grow-1">
            <form class="d-flex search-form custom-nav-link" method="GET" style="min-width: 300px; border: 1px solid #ccc; border-radius: 24px; overflow: hidden;"
                ...
                <button class="search-button d-flex align-items-center justify-content-center" type="submit" style="background-color: #febd69; border: none; padding: 10px 20px; cursor: pointer; width: 50px; height: 50px;">
            ...
            <div id="mySidebar" class="sidebar">
                ...
                <form method="post" action="{{ route('logout') }}" id="form-logout" class="d-none">
                    @csrf
                        ...
                        <span class="welcome-text">Benvenuto, {{ Auth::user()->name }}</span>

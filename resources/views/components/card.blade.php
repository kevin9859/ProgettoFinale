<div class="card2">
    ...
    <div class="card2-footer text-muted d-flex flex-column align-items-start">
        <div class="footer-content d-flex flex-column align-items-start">
            ...
            <div class="card2-footer d-flex align-items-center justify-content-between">
                <div>
                ...
                <div class="card2-footer ml-auto d-flex">
                    <a class="btn-read2" href="{{ route('article.show', ['article' => $article->id]) }}" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Leggi l'articolo</a>
                </div>
            </div>
        </div>
    </div>